...
public class FrereSoeursInterface extends JFrame {
    Interface1 inter;
    JLabel aff;
    ...
    public FrereSoeursInterface(Interface1 in) {
        inter = in;
        ...
        aff = new JLabel("<html><div style='color: black; font-family: \"Times New Roman\", sans-serif; font-size: 36pt; font-weight: bold;'>Bienvenue dans l'interface des Frere Soeurs ,<br>Vous pouvez afficher les (demi) Frere et Soeurs de la personne choisie</div></html>");
        ...
        AfficherBotFreresSoeurs br = new AfficherBotFreresSoeurs(inter, this);
        ...
        RetourBotFreresSoeurs retourbot = new RetourBotFreresSoeurs(this);
