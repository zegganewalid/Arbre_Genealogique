...
public class FemmeInterface extends JFrame {
    public JLabel aff;
    ...
    public FemmeInterface(Interface1 i) {
        inter = i;
        this.setTitle("Formulaire de création d'une Femme");
        ...
        aff = new JLabel("Saisissez les informations de la Femme :");
        ...
        DateMortItemListenerFemme dateMortListener = new DateMortItemListenerFemme(jourMort, moisMort, anneeMort, chkDateMort);
        ...
        AjouterFemmeBot ajouterFemmeBot = new AjouterFemmeBot(inter,this);
        btnAjouter.addActionListener(ajouterFemmeBot);
        ...
        ReteurnBotFemmeInterface returnBotFemmeInterface = new ReteurnBotFemmeInterface(this);
        btnRetour.addActionListener(returnBotFemmeInterface);
